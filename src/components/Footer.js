    ...
    <footer className='bg-dark'>
      <div className="container py-3">
        ...
        <div className="col-md">
            ...
            <p>Developed By <a className="pointer text-decoration-none text-light footer-link" href="https://happykumar.tk/" target="_blank" rel="noreferrer">Rahul Bishnoi</a></p>
          </div>
