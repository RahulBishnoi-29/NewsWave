...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    setLoading(true);
    const url = `https://newsapi.org/v2/top-headlines?apiKey=cc5d2e5f6b7b40ac9dfd564a42970080&country=${props.country}&category=${props.category}&pageSize=${props.pageSize}&page=${page}`;
